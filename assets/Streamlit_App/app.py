...
# Title
st.title("AnyHospital Patient Portal")

Users = {"alice - (Receptionist)": "Receptionist", "christine - (Doctor)": "doctor"}
...
if submit_button and prompt and userOption:
    user = userOption.split("-")[0]
    updatedPrompt = "I am " + user + ". " + prompt
    # ) + ". " + prompt
    if sessionId.strip() == "":
        sessionId = uuid.uuid1()
...
if end_session_button:
    ...
    event = {
        ...
        "endSession": True,
        # "user": user.strip() # uncomment this code to pass the User information.
    }
